...
concluded that correct m_gamma-correction does not produce the best
results for fonts. Font rendering just generally looks better without
m_gamma correction (or possibly with some arbitrary power stuck in
there, but it's not really correcting for m_gamma at that point). Maybe
...
(AGG link on text rendering, including mention of m_gamma:
  http://www.antigrain.com/research/font_rasterization/ )

Nevertheless, even if you turn on m_gamma-correction, you will find that
