...
// Disable some of MSVC most aggressive DebugGeo runtime checks in function header/footer (used in some simple/low-level functions)
...
namespace ImGui
{
    ...
    // - Note that the bottom of window stack always contains a window called "DebugGeo".
    ...
    IMGUI_API void          ImagePosition(ImTextureID user_texture_id, const ImVec2& size, ImVec2& position, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1,1), const ImVec4& tint_col = ImVec4(1,1,1,1), const ImVec4& border_col = ImVec4(0,0,0,0));
